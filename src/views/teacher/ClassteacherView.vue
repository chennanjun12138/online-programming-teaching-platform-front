<template>
    <div>
        ...
        <div>
            ...
            <el-select v-if="tableVisible" v-model="params.sort" clearable placeholder="请选择课程类型" style="margin-left: 5px;width: 200px;">
...
import {
    ...
    findcourse,
    submitcourse, addcontract, findquestion, addBatchcontract,
    findquestionbanks
} from "@/api/index.js";
let params = ref({
    name: '',
