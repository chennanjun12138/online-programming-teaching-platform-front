  ...
  <div>
    ...
    <div>
      <el-table :data="tableData" style="width: 100%; margin: 15px 0px" ref="table"
        ...
        <el-table-column prop="name" label="题目名称" width="120px"></el-table-column>
        <el-table-column prop="type" label="题目类型" width="80px"></el-table-column>

        <el-table-column prop="description" label="题目描述" width="120px"></el-table-column>
